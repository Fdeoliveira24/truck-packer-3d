...
| `docs/product/PROJECT_TREE.md` | Repository snapshot | Generated | No active authority | incomplete | Regenerate from FileTree Pro after approved snapshot milestones; do not hand-edit paths | Current repository tree | Generated 2026-07-15; point-in-time reference only. |
