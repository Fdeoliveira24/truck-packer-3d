...
import { buildLegacyAutoPackItems, solveLegacyAutoPack } from './services/autopack-legacy-solver.js';
...
(async function () {
  ...
  window.TruckPackerApp = (function () {
    ...
    const AutoPackEngine = (() => {
      ...
      //
      // app.js keeps AutoPack orchestration only. The current legacy placement
      // engine is isolated in services/autopack-legacy-solver.js until the
      // logistics-first solver is ready to replace it.
